...
const questions1 = ` Что такое контекст вызова функции? Чем определяется?
...
Какие есть модульные системы в js
Что такое SOLID?
Что такое KISS?
Что такое DRY?
Что такое YAGNI?
Что такое MVC?
Какие есть группы паттернов проектирования?
Как реализовать наследование на функциях?
10 методов массивов
10 методов строки
10 методов объекта
5 методов числа
